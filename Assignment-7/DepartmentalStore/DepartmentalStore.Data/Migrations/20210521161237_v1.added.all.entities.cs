        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Code = table.Column<string>(maxLength: 100, nullable: false),
                    AvailableQuantity = table.Column<int>(nullable: false, defaultValue: 0)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    OpeningStock = table.Column<int>(nullable: false, defaultValue: 0),
                    StockPurchased = table.Column<int>(nullable: false, defaultValue: 0),
                    StockSold = table.Column<int>(nullable: false, defaultValue: 0),
