...
namespace DepartmentalStore.UI
{
    static class DBOperation
    {
        ...
        public static void AddStaffData()
        {
            Staff[] _list = 
            {
                new Staff{ FirstName="Person1", LastName="last1", AddressID=3, DesignationID=1, PhoneNumber="1568234098", Gender='M' },
                new Staff{ FirstName="Person2",LastName="last2",AddressID=4,DesignationID=2,PhoneNumber="5162234098",Gender='F' },
                new Staff{ FirstName="Person3", LastName="last3",AddressID=4,DesignationID=3,PhoneNumber="1569234098",Gender='F'},
                new Staff{ FirstName="Person4", LastName="last4",AddressID=5,DesignationID=3,PhoneNumber="1234567890",Gender='M'},
            };
