...
namespace DepartmentalStore.UI
{
    public static class QuerySolution
    {
        ...
        public static void QueryStaff(Func<Product,bool> query)
        {
        ...
        public static void QueryStaffWithJoin<T>(System.Linq.Expressions.Expression<Func<Product, T>> joinquery,Func<Product, bool> query)
        {
            var staffs = _context.Staff.AsNoTracking();
